...
- **Routing** — routing tables & longest-prefix match, default gateway, static vs dynamic routing, routing protocols (RIP/OSPF/EIGRP/BGP), IGP vs EGP, Linux `ip route` & policy routing.
